...
FOR EACH ROW 
WHEN ((OLD.p1team IS DISTINCT FROM NEW.p1team OR OLD.p2team IS DISTINCT FROM NEW.p2team) AND ((NEW.p1team IS DISTINCT FROM null OR OLD.p2team IS DISTINCT FROM null) OR (OLD.p1team IS DISTINCT FROM null OR NEW.p2team IS DISTINCT FROM null)) AND NEW.turn IS DISTINCT FROM null)
